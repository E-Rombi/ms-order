package br.com.eduardo.msorder.shared.model
...
class Order(
    ...
    @field:DynamoDBAttribute
    var totalQuantities: BigDecimal = BigDecimal.ZERO
    ...
    fun calcOrder() {
        this.totalQuantities = this.items.map { it.quantity }.sumOf { it }
        ...
        this.totalOrder = this.items.map { it.totalItem }.sumOf { it }
    }

    fun canBeConfirmed() = this.status.allowToConfirmed()
...
enum class OrderStatus {
    OPENNED {
        override fun allowToConfirmed():Boolean = true
    },
    CANCELLED {
        override fun allowToConfirmed(): Boolean = false
    },
    CONFIRMED {
        override fun allowToConfirmed(): Boolean = false
    },
    ...
    abstract fun allowToConfirmed(): Boolean
}